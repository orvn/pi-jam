; JAMSAM - Speaking language model on Atari 800
; jambo + formant speech synthesis via POKEY ch2-4
...
vbi_cursor:
        ...
        sta ($5E),y
@vx:    jsr sam_tick      ; advance speech every frame
        jmp (old_vbi)    ; chain to previous deferred VBI

; =====================================================
; SAM SPEECH ENGINE (uses POKEY channels 2-4, ch1 reserved for thinking)
; =====================================================
