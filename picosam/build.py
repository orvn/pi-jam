...
def main() -> None:
    parser = argparse.ArgumentParser(description="Build PICO SAM.")
    ...
    run([ca65, "jampico_sam.asm", "-o", "jampico_sam.o"])
    run([ld65, "-C", "jampico.cfg", "-o", str(dist / "picosam.xex"), "jampico_sam.o"])
    verify_blob(args.weights, dist / "picosam.xex")
    print(f"OK: {dist / 'picosam.xex'}")
